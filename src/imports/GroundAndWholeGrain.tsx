import svgPaths from "./svg-zrvi14mdfr";
...
function CostaRica() {
  return (
    <div className="absolute contents left-[149px] top-[calc(40%+14.2px)]" data-name="COSTA RICA">
      <Group2 />
      <div className="absolute h-[278px] left-[150px] top-[calc(40%+14.2px)] w-[211px]" data-name="AZqUPPAHserxLFWe6N5pFA-AZqUPPAH0kZKDiXFauZV-w">
        <img alt="" className="block max-w-none size-full" height="278" src={imgAZqUppaHserxLfWe6N5PFaAZqUppah0KZkDiXFauZvW} width="211" />
      </div>
    </div>
  );
}
...
function Colombia() {
  return (
    <div className="absolute contents left-[1027px] top-[calc(40%+31.2px)]" data-name="COLOMBIA">
      <Group5 />
      <div className="absolute h-[253px] left-[1027px] top-[calc(40%+31.2px)] w-[248.5px]" data-name="AZqUOqy4roo3eRYVDc1JNw-AZqUOqy5UEkcTqjtiL8-ig">
        <img alt="" className="block max-w-none size-full" height="253" src={imgAZqUOqy4Roo3ERyvDc1JNwAZqUOqy5UEkcTqjtiL8Ig} width="248.5" />
      </div>
    </div>
  );
}
...
function Brasil() {
  return (
    <div className="absolute contents left-[757px] top-[calc(40%+24.2px)]" data-name="BRASIL">
      <Group4 />
      <div className="absolute h-[268px] left-[801px] top-[calc(40%+24.2px)] w-[135px]" data-name="AZqUPEOxEXL_nvFefi7hTQ-AZqUPEOxtYuX9NAoZUfPaw">
        <img alt="" className="block max-w-none size-full" height="268" src={imgAZqUpeOxExlNvFefi7HTqAZqUpeOxtYuX9NAoZUfPaw} width="135" />
      </div>
    </div>
  );
}
...
function Ethiopia() {
  return (
    <div className="absolute contents left-[461px] top-[calc(40%+31.2px)]" data-name="ETHIOPIA">
      <Group3 />
      <div className="absolute h-[243px] left-[506px] top-[calc(40%+31.2px)] w-[149px]" data-name="AZqUO2VOCdsA7HqyHrcdQA-AZqUO2VORqVvWgYhZmK72A">
        <img alt="" className="block max-w-none size-full" height="243" src={imgAZqUo2VoCdsA7HqyHrcdQaAZqUo2VoRqVvWgYhZmK72A} width="149" />
      </div>
    </div>
  );
}

export default function GroundAndWholeGrain() {
  return (
    <div className="bg-white relative size-full" data-name="Ground and Whole Grain">
      <Group />

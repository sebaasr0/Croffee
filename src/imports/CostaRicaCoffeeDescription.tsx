import svgPaths from "./svg-gskfa2xxtp";
import imgImage3 from "figma:asset/91c02f8b27af991163ce628a09396102ce826e16.png";
import imgAZqUppaHserxLfWe6N5PFaAZqUppah0KZkDiXFauZvW from "figma:asset/e5b920f2e6322f596b4f638c74e7951730bcb6b3.png";
  ...
  return (
    <div className="absolute contents left-[732px] top-[calc(10%+32.3px)]">
      <div className="absolute font-['Actor:Regular',sans-serif] h-[180px] leading-[normal] left-[734px] not-italic text-[0px] text-black top-[calc(10%+32.3px)] w-[462px]">
        <p className="mb-0 text-[48px]">COSTA RICA COFFEE</p>
        <p className="mb-0 text-[24px]">&nbsp;</p>
        <p className="mb-0 text-[24px]">$14.99</p>
...
function Group3() {
  return (
    <div className="absolute contents left-[720px] top-[calc(40%+59.2px)]">
      <div className="absolute bg-white h-[38px] left-[720px] rounded-[20px] top-[calc(40%+59.2px)] w-[140px]" data-name="Rounded rectangle">
        <div aria-hidden="true" className="absolute border border-black border-solid inset-0 pointer-events-none rounded-[20px]" />
      </div>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[747px] not-italic text-[20px] text-black text-nowrap top-[calc(40%+66.2px)] whitespace-pre">GROUND</p>
    </div>
  );
}
...
function Group4() {
  return (
    <div className="absolute contents left-[878px] top-[calc(40%+59.2px)]">
      <div className="absolute bg-white h-[38px] left-[878px] rounded-[20px] top-[calc(40%+59.2px)] w-[190px]" data-name="Rounded rectangle">
        <div aria-hidden="true" className="absolute border border-black border-solid inset-0 pointer-events-none rounded-[20px]" />
      </div>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[905px] not-italic text-[20px] text-black text-nowrap top-[calc(40%+66.2px)] whitespace-pre">WHOLE GRAIN</p>
    </div>
  );
}
...
function Group6() {
  return (
    <div className="absolute contents left-[720px] top-[calc(50%+51.5px)]">
      <div className="absolute bg-[#999eb6] h-[51px] left-[720px] rounded-[20px] top-[calc(50%+51.5px)] w-[473px]" />
      <p className="absolute font-['Inter:Extra_Bold',sans-serif] font-extrabold h-[20px] leading-[normal] left-[901px] not-italic text-[16px] text-black top-[calc(50%+67.5px)] w-[122px]">ADD TO CART</p>
    </div>
  );
}

export default function CostaRicaCoffeeDescription() {
  return (
    <div className="bg-white relative size-full" data-name="COSTA RICA COFFEE DESCRIPTION">
      <Group />
      <div className="absolute h-[499px] left-[174px] top-[calc(20%+2.6px)] w-[379px]" data-name="AZqUPPAHserxLFWe6N5pFA-AZqUPPAH0kZKDiXFauZV-w">
        <img alt="" className="block max-w-none size-full" height="499" src={imgAZqUppaHserxLfWe6N5PFaAZqUppah0KZkDiXFauZvW} width="379" />
      </div>
      ...
      <Group5 />
      <div className="absolute font-['Inter:Regular',sans-serif] font-normal h-[193px] leading-[normal] left-[720px] not-italic text-[16px] text-black top-[calc(60%+56.8px)] w-[536px]">
        <p className="mb-0">Our most authentic specialty coffee, grown in the highlands of Costa Rica, where volcanic soil and cool mountain air are exceptional. With an 86.5 S.C.A score, this washed coffee stands out for its clean, sweet fragrance and delicate hints of raw sugar, soft cocoa, and natural vanilla.</p>
        <p className="mb-0">Beany, our adventurous little coffee scout, describes this cup as balanced and vibrant, with notes of light honey, citrus fruits, and a touch of milk chocolate. Its bright acidity and silky body create a smooth, harmonious experience that captures the pure essence of Costa Rican coffee.</p>
        <p>Available in Whole Grain and Ground.</p>
      </div>
      <Group6 />
      <div className="absolute h-[31px] left-[1107px] rounded-[5px] top-[calc(40%+62.2px)] w-[24px]" data-name="image 4">
      ...
      <div className="absolute h-[31px] left-[1139px] rounded-[5px] top-[calc(40%+62.2px)] w-[24px]" data-name="image 5">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[5px]">
          <img alt="" className="absolute h-[203.23%] left-[-83.33%] max-w-none top-[-51.61%] w-[262.5%]" src={imgImage4} />
        </div>
      </div>
      <p className="absolute font-['Aclonica:Regular',sans-serif] h-[46px] leading-[normal] left-[28px] not-italic text-[16px] text-black top-[calc(10%+34.3px)] w-[146px]">GO BACK</p>
    </div>
  );
}
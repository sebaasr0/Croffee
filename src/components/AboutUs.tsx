...
export function AboutUs({ onClose }: AboutUsProps) {
  return (
    <div className="bg-white relative size-full min-h-screen pt-[89px]" data-name="About Us">
      <p className="absolute font-['Aclonica:Regular',sans-serif] h-[51px] leading-[normal] left-[600px] not-italic text-[48px] text-black top-[108px] w-[239px]">CROFFEE</p>
      <div className="absolute font-['Actor:Regular',sans-serif] h-[324px] leading-[normal] left-[725px] not-italic text-[24px] text-black text-center top-[308px] translate-x-[-50%] w-[1168px]">
      ...
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.004820880480110645)+(var(--transform-inner-height)*0.9999883770942688)))] items-center justify-center left-[-13px] top-[169px] w-[calc(1px*((var(--transform-inner-height)*0.004820880480110645)+(var(--transform-inner-width)*0.9999883770942688)))]" style={{ "--transform-inner-width": "1453", "--transform-inner-height": "0" } as React.CSSProperties}>
      ...
      <button 
        onClick={onClose}
        className="absolute font-['Aclonica:Regular',sans-serif] h-[50px] leading-[normal] left-[46.5px] not-italic text-[36px] text-black text-center top-[118px] translate-x-[-50%] w-[57px] cursor-pointer hover:opacity-70 transition-opacity"
      >
        X
      </button>
      <div className="absolute h-[425px] left-[112px] top-[257px] w-[1225px]">
